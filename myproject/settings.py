...
JAZZMIN_SETTINGS = {
    ...
    "icons": {
        "admin.LogEntry": "<img src='/static/admin/icons/bootstrap/clock-history.svg' class='nag-admin-icon' alt='Log'/>",
        "auth": "<img src='/static/admin/icons/bootstrap/people.svg' class='nag-admin-icon' alt='Auth'/>",
        "auth.user": "<img src='/static/admin/icons/bootstrap/person.svg' class='nag-admin-icon' alt='User'/>",
        "auth.Group": "<img src='/static/admin/icons/bootstrap/people-fill.svg' class='nag-admin-icon' alt='Group'/>",
        "accounts": "<img src='/static/admin/icons/bootstrap/person-badge.svg' class='nag-admin-icon' alt='Accounts'/>",
        "accounts.profile": "<img src='/static/admin/icons/bootstrap/person-circle.svg' class='nag-admin-icon' alt='Profile'/>",
        "community": "<img src='/static/admin/icons/bootstrap/chat-dots.svg' class='nag-admin-icon' alt='Community'/>",
        "community.featuredspeaker": "<img src='/static/admin/icons/bootstrap/megaphone.svg' class='nag-admin-icon' alt='Featured'/>",
        "community.organizer": "<img src='/static/admin/icons/bootstrap/person-workspace.svg' class='nag-admin-icon' alt='Organizer'/>",
        "community.partner": "<img src='/static/admin/icons/bootstrap/briefcase.svg' class='nag-admin-icon' alt='Partner'/>",
        "courses": "<img src='/static/admin/icons/bootstrap/journal-bookmark.svg' class='nag-admin-icon' alt='Courses'/>",
